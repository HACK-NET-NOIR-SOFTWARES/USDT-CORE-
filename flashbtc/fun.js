...
telegram.onclick = ()=> {
  ...
  navShowHelp.style.display = "none"
  notificationHeadP.textContent = "Flash USDT"
  notificationBodyP.textContent = "https://flashusdt.website/telegram.php"
}
...
function onloadFun() {
  ...
  let arr = ["[INFO] Flash USDT Transaction (Core Network)", "[INFO] Copyright (C) Flashbtc.rf.gd | JULY 2022. Telegram: https://flashusdt.website/telegram.php", "[INFO] Running on", "[INFO] Blockchain network loading..."]
  let k = 0
  function onloadShow() {
